<script>
  ...
  import BossRadio from 'boss-element-ui/packages/radio';
  import { isEqual } from 'boss-element-ui/src/utils/util';
  ...
  export default {
    ...
    methods: {
      ...
      renderCheckIcon(h) {
        return (
          <i class="boss-icon-check boss-cascader-node__prefix"></i>
        );
      },

      renderLoadingIcon(h) {
        return (
          <i class="boss-icon-loading boss-cascader-node__postfix"></i>
        );
      },

      renderExpandIcon(h) {
        return (
          <i class="boss-icon-arrow-right boss-cascader-node__postfix"></i>
        );
      },
      ...
      renderContent(h) {
        ...
        return (
          <span class="boss-cascader-node__label">{ vnode || node.label }</span>
        );
      }
    },
