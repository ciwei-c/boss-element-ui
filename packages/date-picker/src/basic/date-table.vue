<template>
  <table
    cellspacing="0"
    cellpadding="0"
    class="boss-date-table"
    @click="handleClick"
    @mousemove="handleMouseMove"
    :class="{ 'is-week-mode': selectionMode === 'week' }">
    <tbody>
    <tr>
      <th v-if="showWeekNumber">{{ t('boss.datepicker.week') }}</th>
      <th v-for="(week, key) in WEEKS" :key="key">{{ t('boss.datepicker.weeks.' + week) }}</th>
    </tr>
    <tr
      class="boss-date-table__row"
