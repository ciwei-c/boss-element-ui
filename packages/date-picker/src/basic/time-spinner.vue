<template>
  <div class="boss-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <boss-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="boss-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="boss-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="boss-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="boss-time-spinner__arrow boss-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="boss-time-spinner__arrow boss-icon-arrow-down"></i>
        <ul class="boss-time-spinner__list" ref="hours">
          <li
            class="boss-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="boss-time-spinner__arrow boss-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="boss-time-spinner__arrow boss-icon-arrow-down"></i>
        <ul class="boss-time-spinner__list" ref="minutes">
          <li
            class="boss-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="boss-time-spinner__arrow boss-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="boss-time-spinner__arrow boss-icon-arrow-down"></i>
        <ul class="boss-time-spinner__list" ref="seconds">
          <li
...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'boss-element-ui/src/utils/date-util';
  import BossScrollbar from 'boss-element-ui/packages/scrollbar';
  import RepeatClick from 'boss-element-ui/src/directives/repeat-click';
