<template>
  <transition name="boss-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="boss-picker-panel boss-date-range-picker boss-popper"
      :class="[{
      ...
      <div class="boss-picker-panel__body-wrapper">
        ...
        <div class="boss-picker-panel__body">
          <div class="boss-date-range-picker__time-header" v-if="showTime">
            <span class="boss-date-range-picker__editors-wrap">
              <span class="boss-date-range-picker__time-picker-wrap">
                <boss-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('boss.datepicker.startDate')"
                  class="boss-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="boss-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <boss-input
                  size="small"
                  class="boss-date-range-picker__editor"
                  :disabled="rangeState.selecting"
                  :placeholder="t('boss.datepicker.startTime')"
                ...
                <time-picker
                  ...
                  :propVisible="minTimePickerVisible"
                  @mounted="$refs.minTimePicker.format=timeFormat">
                </time-picker>
              </span>
            </span>
            <span class="boss-icon-arrow-right"></span>
            <span class="boss-date-range-picker__editors-wrap is-right">
              <span class="boss-date-range-picker__time-picker-wrap">
                <boss-input
                  size="small"
                  class="boss-date-range-picker__editor"
                  :disabled="rangeState.selecting"
                  :placeholder="t('boss.datepicker.endDate')"
                  :value="maxVisibleDate"
                  :readonly="!minDate"
                  @input="val => handleDateInput(val, 'max')"
                  @change="val => handleDateChange(val, 'max')" />
              </span>
              <span class="boss-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <boss-input
                  size="small"
                  class="boss-date-range-picker__editor"
                  :disabled="rangeState.selecting"
                  :placeholder="t('boss.datepicker.endTime')"
                ...
                <time-picker
                  ...
                  :time-arrow-control="arrowControl"
                  :propVisible="maxTimePickerVisible"
                  @mounted="$refs.maxTimePicker.format=timeFormat">
                </time-picker>
              </span>
            </span>
          </div>
          <div class="boss-picker-panel__content boss-date-range-picker__content is-left">
            <div class="boss-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="boss-picker-panel__icon-btn boss-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="boss-picker-panel__icon-btn boss-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="boss-picker-panel__icon-btn boss-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="boss-picker-panel__icon-btn boss-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="boss-picker-panel__content boss-date-range-picker__content is-right">
            <div class="boss-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="boss-picker-panel__footer" v-if="showTime">
        <boss-button
          size="mini"
          type="text"
          class="boss-picker-panel__link-btn"
          @click="handleClear">
          {{ t('boss.datepicker.clear') }}
        </boss-button>
        <boss-button
          plain
          size="mini"
...
<script type="text/babel">
  ...
  export default {
    ...
    computed: {
      ...
      leftLabel() {
        return this.leftDate.getFullYear() + ' ' + this.t('boss.datepicker.year') + ' ' + this.t(`boss.datepicker.month${ this.leftDate.getMonth() + 1 }`);
      },

      rightLabel() {
        return this.rightDate.getFullYear() + ' ' + this.t('boss.datepicker.year') + ' ' + this.t(`boss.datepicker.month${ this.rightDate.getMonth() + 1 }`);
      },
    ...
    components: { TimePicker, DateTable, BossInput, BossButton }
  };
</script>
