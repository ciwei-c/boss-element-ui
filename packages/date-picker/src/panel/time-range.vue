<template>
  <transition
    ...
    <div
      v-show="visible"
      class="boss-time-range-picker boss-picker-panel boss-popper"
      :class="popperClass">
      <div class="boss-time-range-picker__content">
        <div class="boss-time-range-picker__cell">
          <div class="boss-time-range-picker__header">{{ t('boss.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="boss-time-range-picker__body boss-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="boss-time-range-picker__cell">
          <div class="boss-time-range-picker__header">{{ t('boss.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="boss-time-range-picker__body boss-time-panel__content">
            <time-spinner
      ...
      <div class="boss-time-panel__footer">
        <button
          type="button"
          class="boss-time-panel__btn cancel"
          @click="handleCancel()">{{ t('boss.datepicker.cancel') }}</button>
        <button
          type="button"
          class="boss-time-panel__btn confirm"
          @click="handleConfirm()"
          :disabled="btnDisabled">{{ t('boss.datepicker.confirm') }}</button>
      </div>
    </div>
  </transition>
</template>
