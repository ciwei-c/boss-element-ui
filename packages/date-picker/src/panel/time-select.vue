<template>
  <transition name="boss-zoom-in-top" @before-enter="handleMenuEnter" @after-leave="$emit('dodestroy')">
    <div
      ref="popper"
      v-show="visible"
      :style="{ width: width + 'px' }"
      :class="popperClass"
      class="boss-picker-panel time-select boss-popper">
      <boss-scrollbar noresize wrap-class="boss-picker-panel__content">
