<template>
  <div class="boss-image">
    ...
    <img
      v-else
      class="boss-image__inner"
      v-bind="$attrs"
      v-on="$listeners"
      @click="clickHandler"
      :src="src"
      :style="imageStyle"
      :class="{ 'boss-image__inner--center': alignCenter, 'boss-image__preview': preview }">
...
<script>
  ...
  import { on, off, getScrollContainer, isInContainer } from 'boss-element-ui/src/utils/dom';
  import { isString, isHtmlElement } from 'boss-element-ui/src/utils/types';
