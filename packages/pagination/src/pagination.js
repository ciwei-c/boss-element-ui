...
export default {
  ...
  render(h) {
    ...
    const rightWrapper = <div class="boss-pagination__rightwrapper"></div>;
  ...
  components: {
          ...
          <button
            ...
            on-click={ this.$parent.prev }>
            {
              this.$parent.prevText
                ...
                : <i class="boss-icon boss-icon-arrow-left"></i>
            }
          </button>
        );
      }
    ...
    Sizes: {
      ...
      render(h) {
        return (
          <span class="boss-pagination__sizes">
            <boss-select
              ...
              disabled={ this.$parent.disabled }>
              {
                this.pageSizes.map(item =>
                  <boss-option
                    value={ item }
                    label={ item + this.t('boss.pagination.pagesize') }>
                  </boss-option>
                )
              }
            </boss-select>
    ...
    Jumper: {
      ...
      render(h) {
        return (
          <span class="boss-pagination__jump">
            { this.t('boss.pagination.goto') }
            <boss-input
              class="boss-pagination__editor is-in-pagination"
              min={ 1 }
            ...
            { this.t('boss.pagination.pageClassifier') }
          </span>
        );
      }
    },
      ...
      render(h) {
        return (
          typeof this.$parent.total === 'number'
            ? <span class="boss-pagination__total">{ this.t('boss.pagination.total', { total: this.$parent.total }) }</span>
            : ''
        );
      }
    },
