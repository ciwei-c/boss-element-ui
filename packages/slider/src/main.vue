<template>
  <div
    class="boss-slider"
    :class="{ 'is-vertical': vertical, 'boss-slider--with-input': showInput }"
    role="slider"
    :aria-valuemin="min"
    :aria-valuemax="max"
  ...
  >
    ...
    <div
      class="boss-slider__runway"
      :class="{ 'show-input': showInput, 'disabled': sliderDisabled }"
      :style="runwayStyle"
      @click="onSliderClick"
      ref="slider">
      <div
        class="boss-slider__bar"
        :style="barStyle">
      </div>
      <slider-button
        :vertical="vertical"
      ...
      <template v-if="markList.length > 0">
        <div>
          <div
            ...
            class="boss-slider__stop boss-slider__marks-stop"
            :key="key">
          </div>
        </div>
        <div class="boss-slider__marks">
          <slider-marker
        ...
        if (this.range && Array.isArray(val)) {
          if (val[1] < this.min) {
            ...
            if (this.valueChanged()) {
              this.dispatch('BossFormItem', 'boss.form.change', [this.minValue, this.maxValue]);
