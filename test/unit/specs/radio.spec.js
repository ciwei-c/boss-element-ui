...
describe('Radio', () => {
  ...
  it('create', done => {
    vm = createVue({
      template: `
        <boss-radio v-model="radio" label="a">
        </boss-radio>
      `,
      data() {
        return {
    ...
    let radioElm = vm.$el;
    expect(radioElm.classList.contains('boss-radio')).to.be.true;
    radioElm.click();
    setTimeout(_ => {
  ...
  describe('Radio group', () => {
      ...
      vm = createVue({
        template: `
          <boss-radio-group v-model="radio">
            <boss-radio :label="3" ref="radio1">备选项</boss-radio>
            <boss-radio :label="6" ref="radio2">备选项</boss-radio>
    ...
    it('disabled', done => {
      vm = createVue({
        template: `
          <boss-radio-group v-model="radio" disabled>
            <boss-radio :label="3" ref="radio1">备选项</boss-radio>
            <boss-radio :label="6" ref="radio2">备选项</boss-radio>
            <boss-radio :label="9">备选项</boss-radio>
          </boss-radio-group>
    ...
    it('change event', done => {
      vm = createVue({
        template: `
          <boss-radio-group v-model="radio" @change="onChange">
    ...
    it('disabled when children is radio button', done => {
      vm = createVue({
        template: `
          <boss-radio-group v-model="radio" disabled>
            <boss-radio-button :label="3" ref="radio1">备选项</boss-radio-button>
            <boss-radio-button :label="6" ref="radio2">备选项</boss-radio-button>
            <boss-radio-button :label="9">备选项</boss-radio-button>
          </boss-radio-group>
        `,
        data() {
          return {
    ...
    it('keyboard event', done => {
      vm = createVue({
        template: `
          <boss-radio-group v-model="radio">
            <boss-radio-button ref="radio1" :label="3">备选项</boss-radio-button>
            <boss-radio-button ref="radio2" :label="6">备选项</boss-radio-button>
            <boss-radio-button ref="radio3" :label="9">备选项</boss-radio-button>
          </boss-radio-group>
        `,
        data() {
          return {
    ...
    describe('Radio Button', () => {
      ...
      it('custom color', done => {
        vm = createVue({
          template: `
            <boss-radio-group v-model="radio" fill="#000" text-color="#ff0">
              <boss-radio-button :label="3" ref="radio1">备选项</boss-radio-button>
              <boss-radio-button :label="6" ref="radio2">备选项</boss-radio-button>
              <boss-radio-button :label="9">备选项</boss-radio-button>
            </boss-radio-group>
      ...
      it('change event', done => {
        vm = createVue({
          template: `
            <boss-radio-group v-model="radio" @change="onChange">
              <boss-radio-button :label="3">备选项</boss-radio-button>
              <boss-radio-button :label="6" ref="radio2">备选项</boss-radio-button>
              <boss-radio-button :label="9">备选项</boss-radio-button>
            </boss-radio-group>
          `,
      ...
      it('size', done => {
        vm = createVue({
          template: `
            <boss-radio-group v-model="radio" size="large">
              <boss-radio-button :label="3" ref="radio1">备选项</boss-radio-button>
              <boss-radio-button :label="6" ref="radio2">备选项</boss-radio-button>
              <boss-radio-button :label="9">备选项</boss-radio-button>
            </boss-radio-group>
        ...
        setTimeout(_ => {
          expect(vm.$el.querySelectorAll('.boss-radio-button--large').length).to.be.equal(3);
          done();
        }, 10);
      });
    });
