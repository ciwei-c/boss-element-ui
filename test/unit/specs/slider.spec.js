...
describe('Slider', () => {
  ...
  it('should not exceed min and max', done => {
    vm = createVue({
      template: `
        <div>
          <boss-slider v-model="value" :min="50">
          </boss-slider>
        </div>
      `,
  ...
  it('hide tooltip', () => {
    vm = createVue({
      template: `
        <div>
          <boss-slider v-model="value" :show-tooltip="false">
          </boss-slider>
        </div>
      `,
  ...
  it('format tooltip', async() => {
    vm = createVue({
      template: `
        <div>
          <boss-slider ref="slider" v-model="value" :format-tooltip="formatTooltip">
          </boss-slider>
        </div>
      `,
  ...
  it('drag', done => {
    vm = createVue({
      template: `
        <div>
          <boss-slider v-model="value" :vertical="vertical"></boss-slider>
        </div>
      `,
  ...
  it('accessibility', done => {
    vm = createVue({
      template: `
        <div>
          <boss-slider v-model="value"></boss-slider>
        </div>
      `,
    ...
    vm = createVue({
      template: `
        <div style="width: 200px;">
          <boss-slider v-model="value" :min="0" :max="1" :step="0.1"></boss-slider>
        </div>
      `,
  ...
  it('change event', done => {
    vm = createVue({
      template: `
        <div>
          <boss-slider v-model="value" @change="onChange">
          </boss-slider>
        </div>
      `,
  ...
  it('disabled', done => {
    vm = createVue({
      template: `
        <div>
          <boss-slider v-model="value" disabled></boss-slider>
        </div>
      `,
  ...
  it('show input', done => {
    ...
    setTimeout(() => {
      triggerEvent(vm.$el.querySelector('.boss-input-number'), 'keyup');
      const inputNumber = vm.$el.querySelector('.boss-input-number').__vue__;
  ...
  it('show stops', () => {
    ...
    const stops = vm.$el.querySelectorAll('.boss-slider__stop');
  ...
  it('vertical mode', done => {
    vm = createVue({
      template: `
        <div>
          <boss-slider vertical v-model="value" height="200px"></boss-slider>
        </div>
      `,
  ...
  describe('range', () => {
    it('basic ranged slider', () => {
      vm = createVue({
        template: `
        <div>
          <boss-slider v-model="value" range></boss-slider>
        </div>
      `,
    ...
    it('should not exceed min and max', done => {
      vm = createVue({
        template: `
        <div>
          <boss-slider v-model="value" range :min="50">
          </boss-slider>
        </div>
      `,
    ...
    it('click', done => {
      vm = createVue({
        template: `
        <div style="width: 200px;">
          <boss-slider range v-model="value"></boss-slider>
        </div>
      `,
    ...
    it('responsive to dynamic min and max', done => {
      vm = createVue({
        template: `
        <div>
          <boss-slider v-model="value" range :min="min" :max="max">
          </boss-slider>
        </div>
      `,
    ...
    it('marks', async() => {
      ...
      waitImmediate();
      const stops = vm.$el.querySelectorAll('.boss-slider__marks-stop.boss-slider__stop');
      const marks = vm.$el.querySelectorAll('.boss-slider__marks .boss-slider__marks-text');
