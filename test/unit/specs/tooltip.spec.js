...
describe('Tooltip', () => {
  ...
  it('create', done => {
    vm = createVue(`
      <boss-tooltip ref="tooltip" content="提示文字">
        <button>click</button>
      </boss-tooltip>`);
  ...
  it('custom popper class', done => {
    vm = createVue(`
      <boss-tooltip ref="tooltip" content="提示文字" popper-class="custom-popper">
        <button>click</button>
      </boss-tooltip>`);
    vm.$nextTick(_ => {
  ...
  describe('manual', () => {
    const vm = createVue({
      template: `
        <boss-tooltip ref="tooltip" manual content="abc" v-model="show">
          <button>click</button>
        </boss-tooltip>
      `,
  ...
  it('light mode', done => {
    vm = createVue(`
      <boss-tooltip ref="tooltip" content="abc" effect="light">
        <button>abc</button>
      </boss-tooltip>
    `);
    vm.$nextTick(_ => {
  ...
  it('hide after', done => {
    vm = createVue(`
      <boss-tooltip ref="tooltip" content="提示文字" :hide-after="300">
        <button>click</button>
      </boss-tooltip>`);
    const tooltip = vm.$refs.tooltip;
    vm.$nextTick(_ => {
  ...
  it('custom tabindex', () => {
    vm = createVue(`
      <boss-tooltip ref="tooltip" content="提示文字" :tabindex="-1">
        <button>click</button>
      </boss-tooltip>
    `, true);
