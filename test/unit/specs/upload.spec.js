...
describe('Upload', () => {
  ...
  describe('ajax upload', () => {
    ...
    it('preview file', done => {
      ...
      handlers.onSuccess = (res, file, fileList) => {
        uploader.$nextTick(_ => {
          uploader.$el.querySelector('.boss-upload-list .is-success a').click();
        });
      };
    ...
    it('file remove', done => {
      ...
      handlers.onSuccess = (res, file, fileList) => {
        uploader.$el.querySelector('.boss-upload-list .boss-icon-close').click();
        uploader.$nextTick(_ => {
